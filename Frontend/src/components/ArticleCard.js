...
import Link from 'next/link';  // 使用 Next.js 提供的 Link 组件
    ...
    <div className="col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700">
      <div className="flex flex-col h-full p-5">
        ...
        <div className="grow mt-2">
          <Link href={link} className="inline-flex text-slate-800 dark:text-slate-100 hover:text-slate-900 dark:hover:text-white mb-1">
        ...
        <footer className="mt-5">
          ...
          <div className="flex justify-between items-center">
            ...
            <div>
              <Link href={link} className="text-sm font-medium text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400">
                View -&gt;
              </Link>
            </div>
          </div>
